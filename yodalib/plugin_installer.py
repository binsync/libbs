...
class YODAPluginInstaller(PluginInstaller):
    def __init__(self):
        super().__init__(targets=PluginInstaller.DECOMPILERS)
        self.plugins_path = Path(str(importlib.resources.files("yodalib"))).joinpath("decompiler_stubs")
    ...
    def install_ghidra(self, path=None, interactive=True):
        ...
        src_script = src_ghidra_yodalib_pkg.joinpath("ghidra_yodalib.py")
        ...
        dst_ghidra_script = ghidra_path.joinpath("ghidra_yodalib.py")
